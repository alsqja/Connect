...
//        entityManager.clear();
//
//        MatchingWithScheduleResDto result1 = matchingService.createMatching(user1.getId(), savedSchedule1.getId(), dto);
//        MatchingWithScheduleResDto result2 = matchingService.createMatching(user2.getId(), savedSchedule2.getId(), dto);
...
//        entityManager.clear();
//
//        NotFoundException e1 = assertThrows(NotFoundException.class, () -> matchingService.createMatching(user2.getId(), savedSchedule2.getId(), dto));
//        NotFoundException e2 = assertThrows(NotFoundException.class, () -> matchingService.createMatching(user1.getId(), savedSchedule1.getId(), dto));
//    }
//}